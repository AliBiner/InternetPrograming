<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SigninPage.aspx.cs" Inherits="_2215010013___Odev6.SigninPage" %>
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form" id="form1" runat="server">
                    <span class="login100-form-title p-b-43">Login to Sign-in Page
                    </span>
                    <div class="wrap-input100 validate-input" >
                        <asp:TextBox ID="txtAd" runat="server" class="input100"></asp:TextBox>
                        <span class="focus-input100"></span>
                        <span class="label-input100">Ad</span>
                    </div>
                    <div class="wrap-input100 validate-input" >
                        <asp:TextBox ID="txtSoyad" runat="server" class="input100"></asp:TextBox>
                        <span class="focus-input100"></span>
                        <span class="label-input100">Soyad</span>
                    </div>
                    <div class="wrap-input100 validate-input">
                        <asp:TextBox ID="txtEmail" runat="server" class="input100" TextMode="Email" ></asp:TextBox>
                        <span class="focus-input100"></span>
                    ...
                    <div class="container-login100-form-btn">
                        <asp:Button ID="btnSend" runat="server" Text="Send" class="login100-form-btn" OnClick="btnSend_Click"/>
                       </div>
                    <div class="container-login100-form-btn">
